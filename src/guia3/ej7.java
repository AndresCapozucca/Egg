...
lecturas correctas e incorrectas recibidas. Para resolver el ejercicio deberá investigar cómo se 
...
public class ej7 {
    ...
    public static void main(String[] args) {
        ...
        String cadena;
        System.out.println("Ingrese una cadena de 5 caracteres maximo que"
                + " empiece con (x) y termine con (o),"
                + " para salir ingrese (&&&&&).");
          int correctas = 0;
          int incorrectas = -1;
        do {
            cadena = leer.nextLine();
            if (cadena.length() == 5 && cadena.substring(0,1).equalsIgnoreCase("x")
                && cadena.substring(4,5).equalsIgnoreCase("o") ){
